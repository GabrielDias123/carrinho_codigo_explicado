...
const produtos = [
    ...
    // Isso registra um ouvinte de evento de clique, quando o documento é clicado, a função de é executada.
    document.body.addEventListener('click', function (event) {
        ...
        if (elemento.classList.contains('btn-remove')){
            ...
            // Esta parte de codigo chama a propriedade renderizaCarrinho() para atualizar a exibição dos itens do carrinho.
            renderizaCarrinho();
